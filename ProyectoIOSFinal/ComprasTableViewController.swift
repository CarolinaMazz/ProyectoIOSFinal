...
class ComprasTableViewController: UITableViewController {
   ...
   override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let celda = tableView.dequeueReusableCell(withIdentifier: "celcomp", for: indexPath) as! itemCompra
    
        celda.lbNombre.text = item.nombre
        celda.img.image = UIImage(named: item.imagen)
        celda.lbPrecio.text = "S./ \(item.precio!)"
        ...
        celda.addGestureRecognizer(swipeGestureRecognizer)
